...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-background">
        ...
        <div className="flex items-center justify-between max-w-6xl mx-auto">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">Smart Navigation & Safety</p>
            </div>
          </div>

          <div className="flex items-center gap-4">
            <div className="text-right">
              <p className="text-sm font-medium text-foreground">{userPoints} pts</p>
      ...
      {/* Navigation Menu */}
      <nav className="bg-card/50 border-b border-border p-4">
      ...
      <main className="max-w-6xl mx-auto p-4 space-y-6">
        ...
        <Card className="bg-gradient-to-r from-primary/5 to-accent/5 border-primary/20">
          <CardContent className="p-6">
            <h2 className="text-2xl font-bold text-foreground mb-2">Welcome to SafeNav</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <CardContent>
              <div className="space-y-2">
                <div className="flex items-center justify-between">
                  <span className="text-sm text-muted-foreground">Main St & 5th Ave</span>
                  <Badge variant="destructive">+15 min</Badge>
                </div>
                <div className="flex items-center justify-between">
                  <span className="text-sm text-muted-foreground">Highway 101 North</span>
          ...
          <Link href="/explore">
            <Card className="border-border bg-card hover:bg-muted/50 transition-colors cursor-pointer">
              ...
              <CardContent>
                <p className="text-sm text-muted-foreground mb-3">Explore nearby places virtually before visiting</p>
                <Button variant="outline" size="sm" className="gap-2 bg-transparent">
